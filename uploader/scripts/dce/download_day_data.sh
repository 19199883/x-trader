...
cd $this_dir
STRA_LOG="/home/u910019/explorer/sc/sett/day28/stra_log/dce_trad_${SUFFIX}_`date +%y%m%d`.tar.gz"
...
cd $this_dir
STRA_LOG="/home/u910019/explorer/sc/sett/day100/stra_log/dce_trad_${SUFFIX}_`date +%y%m%d`.tar.gz"
scp -P 44153 -v "u910019@101.231.3.117:${STRA_LOG}" ${STRATEGY_DIR}
cd ${STRATEGY_DIR}
stra_src="dce_trad_${SUFFIX}_`date +%y%m%d`.tar.gz"
tar -v --remove-files -xzf $stra_src
